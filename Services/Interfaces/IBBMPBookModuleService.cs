...
namespace BBMPCITZAPI.Services.Interfaces
{
    public interface IBBMPBookModuleService
    {
        ...
        #region Classification Document Upload Events
         DataSet INS_NCL_PROPERTY_DOC_BBD_CLASS_TEMP(int PROPERTYCODE, int DOCUMENTTYPEID, int CLASSIFICATIONID, int SUBCLASSIFICATIONID, string DOCUMENTDETAILS, string DOCUMENTNUMBER, string DOCUMENTDATE, string DOCUMENTEXTENSION, byte[] SCANNEDDOCUMENT, string CREATEDBY);
